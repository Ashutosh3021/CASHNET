        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/" className="flex items-center gap-2 bg-amber-400 px-5 py-2 text-xs font-extrabold text-slate-900 hover:bg-amber-300 transition-transform active:scale-95 shadow-[0_0_15px_rgba(245,158,11,0.2)] hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] rounded-sm">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[60] bg-[hsl(214,39%,17%)] flex flex-col pt-16 px-6 animate-fade-in-up">
          ...
          <div className="flex flex-col gap-6 mt-8">
            ...
            <Link href="/" onClick={() => setMobileMenuOpen(false)} className="mt-4 flex items-center justify-center gap-2 bg-amber-400 px-6 py-4 text-sm font-extrabold text-slate-900 rounded-sm">
      ...
      <section className="relative pt-28 pb-16 md:pt-40 md:pb-24 bg-[hsl(214,39%,17%)] overflow-hidden border-b border-slate-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center z-10">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-300 w-full sm:w-auto">
            <Link href="/" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-amber-400 px-8 py-3.5 text-sm font-extrabold text-slate-900 hover:bg-amber-300 transition-transform active:scale-95 rounded-sm shadow-[0_0_15px_rgba(245,158,11,0.2)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            <div className="lg:w-1/3 lg:sticky lg:top-28">
              ...
              <Link href="/" className="inline-flex items-center gap-2 text-xs font-bold text-slate-900 bg-amber-400 px-6 py-3 hover:bg-amber-300 shadow-[0_0_10px_rgba(245,158,11,0.2)] rounded-sm transition-transform active:scale-95">
      ...
      <section className="py-20 md:py-28 bg-white text-center relative border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/" className="w-full sm:w-auto flex justify-center items-center gap-2 bg-[hsl(214,39%,17%)] text-amber-400 px-8 py-3.5 text-sm font-extrabold hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/10 rounded-sm">
