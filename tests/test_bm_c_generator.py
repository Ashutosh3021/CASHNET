...
MODULE=Path(__file__).parents[2]/"scripts"/"complaints"/"generate_bm_c.py"; spec=importlib.util.spec_from_file_location("bm",MODULE); bm=importlib.util.module_from_spec(spec); spec.loader.exec_module(bm)
